  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-slate-900/70 via-slate-900/40 to-slate-900/80 rounded-none" />
      </div>
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10 text-center">
        ...
        <p className="tracking-[0.35em] uppercase text-cyan-300/80 drop-shadow-[0_1px_6px_rgba(0,0,0,0.9)] font-light text-xs my-[11px] py-0 px-[17px] mx-[385px]">Подберём лучшую недвижимость с полным сопровождением сделки</p>
        <a
          href="#contact"
